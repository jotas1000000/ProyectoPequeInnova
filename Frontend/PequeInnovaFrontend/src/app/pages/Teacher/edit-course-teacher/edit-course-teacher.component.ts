...
@Component({
  selector: 'app-edit-course-teacher',
  templateUrl: './edit-course-teacher.component.html',
  styleUrls: ['./edit-course-teacher.component.scss']
})

export class EditCourseTeacherComponent implements OnInit {
      ...
      this.courseService.updateCourse(this.course.id, this.course.areaId, this.course).subscribe((courseResponse: Course) => {
        ...
        if (courseResponse != null) {
          this.course.lessons.forEach(LessonElement => {
            LessonElement.uid = this.user.id;
                ...
                if (boolResponse) {
                  if (LessonElement.type === 'practice') {
                    LessonElement.questions.forEach(QuestionElement => {
                      QuestionElement.uid = this.user.id;
